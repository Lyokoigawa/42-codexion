...
/*                                               +#+#+#+#+#+   +#+            */
/*   Created: 2026/08/08 16:11:41 by username         #+#    #+#              */
/*   Updated: 2026/08/18 13:57:58 by username        ###   ########.fr        */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (dongle_available(request->coder->l_dong, sim)
		&& dongle_available(request->coder->r_dong, sim))
		return (1);
	return (0);
}
